Config { 
    ...
    sepChar = "%",
    alignSep = "}{",
    template = " %StdinReader% }{<fc=#b0d2ff> %kbd%</fc> <fc=#cc9933><icon=/home/sleeping/.xmonad/icons/spkr_01.xbm/> %vol% </fc><fc=#74dea7><icon=/home/sleeping/.xmonad/icons/cpu.xbm/> %cpu% </fc> <fc=#ccaa88>%network%</fc>  <fc=#cc9933><icon=/home/sleeping/.xmonad/icons/bat_low_01.xbm/> %battery%</fc>  %date% "
}
